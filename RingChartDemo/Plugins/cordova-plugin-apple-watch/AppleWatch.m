...
- (void) init:(CDVInvokedUrlCommand*)command;
{
    ...
    self.watchConnectivityWormhole = [[MMWormhole alloc] initWithApplicationGroupIdentifier:appGroupId
...
- (void) sendMessage:(CDVInvokedUrlCommand*)command;
{
    ...
    [self.watchConnectivityWormhole passMessageObject:@{@"selectionString" : message} identifier:queueName];
